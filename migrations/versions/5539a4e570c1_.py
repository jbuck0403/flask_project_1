...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['enemyID'], ['user.id'], ),
    sa.ForeignKeyConstraint(['playerID'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['battleID'], ['battle.id'], ),
    sa.ForeignKeyConstraint(['enemyPkmnID'], ['pkmn.id'], ),
    sa.ForeignKeyConstraint(['playerPkmnID'], ['pkmn.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('turn_description',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('battleID', sa.Integer(), nullable=False),
    sa.Column('turnID', sa.Integer(), nullable=False),
    sa.Column('eventDescription', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['battleID'], ['battle.id'], ),
    sa.ForeignKeyConstraint(['turnID'], ['turn.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
